 function R = NoiseExtractBM3D( X, sigma )
%function R = NoiseExtractBM3D( X, sigma )
%
% The function computes the residue through the BM3D algorithm described in [1]. 
%  For color images, the individual channels are processed separately.
%
% INPUT PARAMETERS:
...
% denoising delle singole bande di colore
for i=1:Nb
    [void Z_norm] = actual_BM3D( 1, X(:,:,i), sigma, 'lc' );
    R(:,:,i) = X(:,:,i) - 255 * Z_norm;
end
...
function [PSNR, y_est] = actual_BM3D(y, z, sigma, profile, print_to_screen)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Copyright (c) 2006 Tampere University of Technology. All rights reserved.

function [image_noise,image_noisefee] = NoiseExtractMihcak(Img,sigma,wname,L)
% function image_noise = NoiseExtractMihcak(Im,sigma,wname,L); extracts noise signal that is locally Gaussian N(0,sigma^2)
% Input:
...
% Image_noise = NoiseExtract(Im,3,'db4',4);
